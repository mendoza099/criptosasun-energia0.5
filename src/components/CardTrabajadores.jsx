...
import '../css/cardtrabajadores.css';
...
const CardTrabajadores = () => {
    ...
    return (
        <>
            ...
            <div className="colocacion-trabajadores">

                <div className="trabajador1">
                ...
                <div className="trabajador2">

                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704987854/bc93e626-bb86-41d3-b748-9db0007f68c8_1_hvttey.jpg" alt="" />
                ...
                <div className="trabajador3">
                    ...
                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1705074502/fab02960-3188-4ac4-b981-94feeba003c0_1_fcciko.jpg" alt="" />
                ...
                <div className="trabajador4">

                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988294/WhatsApp_Image_2023-11-29_at_12.55.38_1_tdf1xt.jpg" alt="" />
                    <a href="https://www.linkedin.com/in/arantxa-ozc%C3%A1riz-ferrero-75087431/" target="_blank" rel="noopener noreferrer">
                        <img className='manolo1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988618/6297a2f1e01809629f113598_u1me7q.png" alt="Descripción del logo" />
                    </a>
                ...
                <div className="trabajador8">

                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988089/77895ca7-90e1-4704-b140-c126609a99d8_1_cuvqqu.jpg" alt="" />
                ...
                <div className="trabajador9">

                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988289/0f1b49c7-46b4-4e5e-acec-0c9bac5164a0_qabzkf.jpg" alt="" />
                    <a href="https://www.linkedin.com/in/alfredo-talavera-ramajo-62a0ba139/" target="_blank" rel="noopener noreferrer">
                        <img className='manolo1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988618/6297a2f1e01809629f113598_u1me7q.png" alt="Descripción del logo" />
                    </a>
                ...
                <div className="trabajador10">

                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704987886/5b9fa9ba-585d-48e4-ba35-4f0651a9859e_1_yujoen.jpg" alt="" />
                ...
                <div className="trabajador11">

                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988282/WhatsApp_Image_2023-11-29_at_11.57.58_g4nczv.jpg " alt="" />
                    <a href="https://www.linkedin.com/in/ignacio-ozcariz-9b014260/" target="_blank" rel="noopener noreferrer">
                        <img className='manolo1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988618/6297a2f1e01809629f113598_u1me7q.png" alt="Descripción del logo" />
                    </a>
                ...
                <div className="trabajador12">

                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988543/WhatsApp_Image_2023-11-29_at_12.55.19_d3h76z.jpg" alt="" />
                    <a href="https://www.linkedin.com/in/sergio-mendoza-domiguez-744a1b239/" target="_blank" rel="noopener noreferrer">
                        <img className='manolo1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988618/6297a2f1e01809629f113598_u1me7q.png" alt="Descripción del logo" />
                    </a>
                ...
                <div className="trabajador13">
                    ...
                    <img className='perdro1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704987895/260937f1-1b21-4f41-9acc-cd89b9bb0fb7_1_pl8c8t.jpg" alt="" />
                    <a href="https://www.linkedin.com/in/miguel-carmonagarcia/" target="_blank" rel="noopener noreferrer">
                        <img className='manolo1' src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1704988618/6297a2f1e01809629f113598_u1me7q.png" alt="Descripción del logo" />
                    </a>
